...
<table width="621" border="0" cellpadding="2" cellspacing="1" bordercolor="#990000" bgcolor="#ffdd00" align="center">
  ...
  <td width="333" height="46" bgcolor="#ECE9D8" class="style1"><div align="center" class="style8">
    NISN</div></td>
  <td width="277" bgcolor="#ECE9D8" class="style1"><div align="center" class="style8">NAMA SISWA </div></td>
  </tr>
<?php
require("utama.php");
...
while($data=mysql_fetch_array($qry)){
  ...
  ?>
    <tr bgcolor="#00CC99">
    <td bgcolor="#FFFFFF" class="style1"><span class="style20"><?php echo $data['nisn']; ?></span></td>
	<td bgcolor="#FFFFFF" class="style1"><span class="style20"><?php echo $data['nama_siswa']; ?></span></td>
   </tr>
  <?php
  }
  ?>
